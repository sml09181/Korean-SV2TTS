...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--in_dir", type=Path, default="/GENERATION/SV2TTS/synthesizer/preprocessed", help= \
        "Path to the synthesizer directory that contains the mel spectrograms, the wavs and the "
        "embeds. Defaults to  <datasets_root>/SV2TTS/synthesizer/.")
    parser.add_argument("-o", "--out_dir", type=Path, default="/GENERATION/SV2TTS/vocoder", help= \
