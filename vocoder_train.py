...
if __name__ == "__main__":
    ...
    parser.add_argument("-r", "--run_id", type=str, default="jin", help= \
    ...
    parser.add_argument("--syn_dir", type=Path, default="/GENERATION/SV2TTS/synthesizer/test", help= \
        "Path to the synthesizer directory that contains the ground truth mel spectrograms, "
        "the wavs and the embeds. Defaults to <datasets_root>/SV2TTS/synthesizer/.")
    parser.add_argument("--voc_dir", type=Path, default="/GENERATION/SV2TTS/vocoder2", help= \
    ...
    parser.add_argument("-m", "--models_dir", type=Path, default="/scratch3/dvd/GENERATION/result/saved_models", help=\
    ...
    parser.add_argument("-g", "--ground_truth", action="store_true", default="/GENERATION/SV2TTS/synthesizer/test/mels", help= \
